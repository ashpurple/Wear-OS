...
public class AnalogComplicationConfigData {
    ...
    public static ArrayList<ConfigItemType> getDataToPopulateAdapter(Context context) {
        ...
        /**ConfigItemType backgroundColorConfigItem2 =
                new ColorConfigItem2(
                        context.getString(R.string.config_background_color_label),
                        R.drawable.icn_styles,
                        context.getString(R.string.saved_background_color),
                        ColorSelectionActivity2.class);
        settingsConfigData.add(backgroundColorConfigItem2);
**/
        ConfigItemType button=
                new Complication_Button("click",-1);
        settingsConfigData.add(button);

        ConfigItemType button2=
                new Complication_Button2("click",-1);
        settingsConfigData.add(button2);
     ...
     */
    public static class Complication_Button implements ConfigItemType{
        private int colorId;
        private String name;

        Complication_Button(String name, int colorId){
            this.name=name;
        ...
        @Override
        public int getConfigType() {
            return AnalogComplicationConfigRecyclerViewAdapter.HI;
        }
    }
    public static class Complication_Button2 implements ConfigItemType{
        private int colorId;
        private String name;

        Complication_Button2(String name, int colorId){
            this.name=name;
            this.colorId=colorId;
        ...
        @Override
        public int getConfigType() {
            return AnalogComplicationConfigRecyclerViewAdapter.HI2;
        }
    }
  ...
  /**  public static class ColorConfigItem2  implements ConfigItemType {

        private String name;
        private int iconResourceId;
        private String sharedPrefString;
        private Class<ColorSelectionActivity2> activityToChoosePreference;

        ColorConfigItem2(
                String name,
                int iconResourceId,
                String sharedPrefString,
                Class<ColorSelectionActivity2> activity) {
            this.name = name;
            this.iconResourceId = iconResourceId;
            this.sharedPrefString = sharedPrefString;
            this.activityToChoosePreference = activity;
        ...
        public String getSharedPrefString2() {
            return sharedPrefString;
        }

        public Class<ColorSelectionActivity2> getActivityToChoosePreference() {
            return activityToChoosePreference;
        }
